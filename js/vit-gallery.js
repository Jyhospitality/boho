...
(function($) {
    ...
    $.fn.vitGallery = function(options) {
        ...
        var $this = $(this) // .gallery
            ...
            , $galleryControlsUl, $centerThumbnail, $currentControlItem, $galleryControlsInner, controlsInnerPosition, $fullscreenWrap;
            ...
            $imgBlock.each(function() {
                ...
                img.bindImageLoad(function() { //Plugin for load image (look at the end of page)
                    ...
                    setTimeout(function() {
                        ...
                        // Ð¾Ð±Ð½ÑƒÐ»ÑÐµÐ¼ Ð¿ÐµÑ€ÐµÐ¼ÐµÐ½Ð½ÑƒÑŽ, Ñ‡Ñ‚Ð¾Ð±Ñ‹ GC ÑÐ´ÐµÐ»Ð°Ð» ÑÐ²Ð¾ÑŽ Ñ€Ð°Ð±Ð¾Ñ‚Ñƒ
                        img = null;
                    }, 100);
            ...
            switch (direction) {
                case 'next':
                    $controlsItem.eq(currentIndex)
                        ...
                        .animate({
                            width: 0
                        }, settings.thumbnailAnimationSpeed, function() {
                            $(this).css({
                                left: '',
                                width: ''
                            });
        ...
        function goToSlide(thisIndex) {
            ...
            if (settings.thumbnailAnimation) {
                $controlsBlock.find('.current').find('i').css({
                    width: '',
                    left: '',
                    right: ''
                })
